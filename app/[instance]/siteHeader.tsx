        ...
        <div className="mx-auto max-w-7xl flex flex-wrap items-center space-x-8 justify-between px-6 lg:px-8 py-4">
          <div className="flex items-center">
            ...
            <a aria-label="Home page" href="/">
              {largeLogo && largeLogo.url ? <Image className="h-7 hidden sm:block" src={largeLogo.url} alt={"IntegrateWise"} priority width={largeLogo.width} height={largeLogo.height} /> : <Image className="h-7 hidden sm:block" src="/logo.png" alt="IntegrateWise" priority width={257} height={30} />}
              {smallLogo && smallLogo.url ? <Image className="h-7 sm:hidden" src={smallLogo.url} alt={"IntegrateWise"} priority width={smallLogo.width} height={smallLogo.height} /> : <Image className="h-7 sm:hidden" src="/logo-sm.png" alt="IntegrateWise" priority width={30} height={22} />}
            </a>
